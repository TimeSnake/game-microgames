...
dependencies {
    pluginImplementation("de.timesnake:basic-game:3.+") { isTransitive = false }
    pluginImplementation("de.timesnake:library-game:3.+") { isTransitive = false }

    api("de.timesnake:basic-game:3.+")
